          ...
          <ScrollReveal direction="left">
            <div>
              ...
              <div className="space-y-5 text-[rgb(var(--md-sys-color-on-surface-variant))] leading-relaxed">
                <p>
                  hi. im Niko! i like programming and playing/watching football. andd i like graphic designing,roblox gfx making, finding cool fonts and stuff. i play futsal irl asw..!
                </p>
              </div>
            </div>
          </ScrollReveal>
