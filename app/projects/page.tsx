      ...
      <main className="pt-28 max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, index) => (
            <div
              key={index}
              className="md-card opacity-0 animate-slide-in-blur group"
        ...
        {/* More Projects CTA */}
        <div className="mt-20 text-center opacity-0 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
