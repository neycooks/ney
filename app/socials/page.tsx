...
export default function Socials() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="pt-28 max-w-6xl mx-auto px-4 sm:px-6 py-12">
            ...
            {socials.map((social, index) => (
              <ScrollReveal key={social.id} direction="scale" delay={index * 0.1}>
                <a
                  ...
                  className="block bg-[rgb(var(--md-sys-color-surface-container))] rounded-[28px] p-5 sm:p-6 transition-all duration-500 ease-out hover:shadow-lg hover:-translate-y-1 group"
                >
                  <div className="flex flex-row items-center gap-4">
                    <div className="flex-shrink-0 w-14 h-14 rounded-2xl bg-[rgb(var(--md-sys-color-primary-container))] flex items-center justify-center text-[rgb(var(--md-sys-color-on-primary-container))] transition-all duration-500 ease-out group-hover:scale-110 group-hover:rotate-6 group-hover:shadow-lg">
                      {iconMap[social.icon.toLowerCase()] || iconMap.github}
                    </div>
                    <div className="min-w-0 flex-1">
                      <h3 className="text-base sm:text-lg font-semibold text-[rgb(var(--md-sys-color-on-surface))] transition-colors duration-300 group-hover:text-[rgb(var(--md-sys-color-primary))] truncate">
                        {social.name}
                      </h3>
                      <div className="flex items-center gap-1 text-[rgb(var(--md-sys-color-on-surface-variant))] text-xs sm:text-sm mt-1">
                  ...
                  <p className="text-[rgb(var(--md-sys-color-on-surface-variant))] text-sm leading-relaxed mt-4">
                    {social.description}
                  </p>
                </a>
              </ScrollReveal>
