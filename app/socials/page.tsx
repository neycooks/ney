...
const socials = [
  ...
  },
  {
    name: 'Discord',
    url: '#',
    description: 'Join my Discord server to chat and collaborate',
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    name: 'Twitter / X',
    url: '#',
    description: 'Follow me for updates, thoughts, and dev content',
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    name: 'YouTube',
    url: '#',
    description: 'Watch my tutorials, walkthroughs, and devlogs',
    icon: (
      <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
